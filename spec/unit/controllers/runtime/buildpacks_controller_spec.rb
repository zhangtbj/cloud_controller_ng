...
module VCAP::CloudController
  RSpec.describe VCAP::CloudController::BuildpacksController do
    ...
    describe '#create' do
      ...
      # XTEAM TODO
      # We're wondering why we can't change a non-nil stack on a buildpack, but we can change a nil stack
      # What's the difference, because a nil stack means use the default stack, so it amounts to the same change
      # for apps built against the buildpack
      ...
      it 'returns duplicate name message correctly' do
        ...
        #XTEAM TODO why is the response http code changed?
